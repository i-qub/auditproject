...
const ViewAuditEvidenceAud =  ()=>{
  ...
  const data = Proof_Link.map((link) => {
      ...
      const fileName = sanitizedLink; // Extract the file name from the sanitized URL
      ...
      const handleDelete = async (rowData) => {
        try {
        const response = await axios.get('http://13.127.182.122:5000/audit/deleteImage?Audit_Proof_Link='+rowData.heading);
